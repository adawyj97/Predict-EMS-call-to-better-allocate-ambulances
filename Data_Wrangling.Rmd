...
week26.panel <-
  expand.grid(
    interval15=seq(floor_date(ymd_hms(min(week26$call_date_and_time)), unit = "15 mins"),floor_date(ymd_hms(max(EMS.template$call_date_and_time)), unit = "15 mins"), by = '15 mins'),
    uniqueID = unique(fishnet$uniqueID))
```
