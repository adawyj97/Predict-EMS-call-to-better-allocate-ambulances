...
```{r}
vbCensus <- 
  get_acs(geography = "tract", variables = c("B01003_001", "B19013_001", "B02001_002", "B08013_001",                                                        "B08012_001", "B08301_001", "B08301_010", "B11007_001", 
                                        "B12001_003", "B12001_007", "B12001_009", "B12001_010"), 
...
```{r}
# Hospital <- st_read("C:/Users/Xiaoran Wang/Desktop/MUSA507/FinalProject/all_hospital.shp") %>%
#   st_transform(2284)

# hospital_buffer <-st_buffer(Hospital, dist = 10000)
# fishnet_in_buffer <- st_join(hospital_buffer, fishnet, st_contains)
```
